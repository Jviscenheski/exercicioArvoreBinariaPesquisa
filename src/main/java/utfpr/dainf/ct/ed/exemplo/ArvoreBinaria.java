...
public class ArvoreBinaria<E> {
    ...
    protected E valor;
    protected boolean jaVisitado = false;
   ...
   // private ArvoreBinaria<E> noPos;
    ...
    public ArvoreBinaria<E> proximoEmOrdem() {
        ...
        if (!pilha.isEmpty() || ultimoVisitado != null) {
            while (ultimoVisitado != null) {
                //System.out.print(" " + ultimoVisitado.getValor());
     ...
     */
    public ArvoreBinaria<E> proximoPreOrdem() { /* precisa retornar o próximo nó a ser visitado*/    
        ...
        ArvoreBinaria<E> resultado = null;
         ...
         if (inicio) {
            ...
            inicio = false;
            pilha.push(ultimoVisitado);
         } // só entra aqui na primeira vez que a função chamada.
    ...
    public ArvoreBinaria<E> proximoPosOrdem() {
        ...
        // 1 5 4 7 6 3 13 14 10 8
         ...
         if (inicio) {
            ...
            pilha.push(ultimoVisitado);
            //System.out.print(" " + ultimoVisitado.getValor());
            ultimoVisitado.jaVisitado = true;
         } // só entra aqui na primeira vez que a função chamada.
         
        if(ultimoVisitado == null)
            return ultimoVisitado;
        
        //System.out.print(" " + pilha.size());
        
        if(!pilha.isEmpty()){
            while(ultimoVisitado != null){
                
                if(!ultimoVisitado.jaVisitado)
                    pilha.push(ultimoVisitado);
            ...
            if(!pilha.isEmpty())
                ultimoVisitado = pilha.peek();
            //System.out.print(" " + ultimoVisitado.getValor());
            
            if(ultimoVisitado.direita != null){
                if(!ultimoVisitado.direita.jaVisitado)
                    ultimoVisitado = ultimoVisitado.direita;
                else
                    ultimoVisitado = resultado;
            }
    ...
    public ArvoreBinaria<E> proximoEmNivel() {
        ...
        if(!fila.isEmpty()){
           ...
           if(ultimoVisitado.esquerda != null){
              fila.add(ultimoVisitado.esquerda);
              //System.out.print(" " + ultimoVisitado.esquerda.getValor());
           }
           
           if(ultimoVisitado.direita != null){
              fila.add(ultimoVisitado.direita);
              //System.out.print(" " + ultimoVisitado.direita.getValor());
           }
